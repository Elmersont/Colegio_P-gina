    ...
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        <Navbar.Brand href="#" className="d-flex align-items-center ms-5">
            <img
            src="/assets/images/Logo CLG.jpeg" // Ruta de la imagen en la carpeta public
            alt="Escudo Colegio Lucila Godoy"
            width="90" // Ancho de la imagen, puedes ajustar según sea necesario
            height="130" // Alto de la imagen, ajustable
